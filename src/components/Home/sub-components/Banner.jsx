            ...
            <div className='flex flex-col justify-center items-center'>
                <div className="flex flex-col justify-center items-center">
                    ...
                    <div className='w-[90%] lg:w-[50%] flex flex-col lg:flex-row justify-between items-center mt-10'>
                        <NavLink to={'/'} className={"bg-[#CB2027] text-white px-14 py-2 rounded mb-5 lg:mb-0"}>Contact Now</NavLink>
                        <NavLink to={'/products'} className={"text-black px-4 py-2 border border-black rounded lg:mr-24"}>Check out our Products</NavLink>
                    </div>
            </div>
